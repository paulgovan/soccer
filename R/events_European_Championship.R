#' European Championship events data set
#'
#' Events data set for the European Championship.
#'
...
#' \item{eventSec}{The time when the event occurred in seconds since the beginning
...
#' }
#' @examples
#'   dim(events_European_Championship)
#'   head(events_European_Championship)
