#' European Championship matches data set
#'
#' Matches data set for the European Championship.
#'
...
#' }
#' @examples
#'   dim(matches_European_Championship)
#'   head(matches_European_Championship)
